...
class Mailer extends helper.Mail {
	...
	formatAddresses(recipients) {
		return recipients.map(({ email }) => {
			//For every recipient in the array we pull out the email property. extra set of () around email is necessary for destructuring with an arrow function.
